...
## Plotting ###########################
plt.ion()
if D.bouncing_particles is True:
    sti = 'plots/direction+bouncing'
elif D.gaussian_v is True:
    sti = 'plots/Gaussian_v'
elif D.gaussian_u is True:
    sti = 'plots/Gaussian_u'
elif D.bursting_process is True:
    sti = 'plots/bursting'
else:
    sti = 'plots/unmodified'
...
# Use data for Re = 1000 and for T = 10
r = 0; t = 2
n, bins, patches = plt.hist(X[t, r, :],30)
#y = mlab.normpdf(bins,Xmean[t,r],Xvar[t,r])
#plt.plot(bins,max(n)*y)

plt.title('Histrogram of final X position')
plt.ylabel('$N$')
plt.xlabel('$X$')
...
plt.title('Histrogram of final Y position')
plt.xlabel('$N$')
plt.ylabel('$Y$')
...
plt.colorbar()
plt.title('Concentration of neutral dispersant')
plt.xlabel('$X$')
plt.ylabel('$Y$')
...
plt.colorbar()
plt.title('Concentration of neutral dispersant, T = %i' % T[t])
plt.xlabel('$X$')
plt.ylabel('$Y$')
